...
export function MarketChart({ title, data, color }: MarketChartProps) {
            ...
            return (
              <View key={index} style={styles.barGroup}>
                ...
                <View style={styles.barTrack}>
                  <View style={[styles.bar, { height: `${heightPct}%` as any, backgroundColor: color }]} />
                </View>
...
const styles = StyleSheet.create({
  ...
  chart: { flexDirection: 'row', alignItems: 'flex-end', height: 100, gap: Spacing.sm },
  barGroup: { alignItems: 'center', width: 44 },
  barValue: { fontSize: Typography.sizes.xs, color: Colors.textSecondary, marginBottom: 2 },
  barTrack: { width: 22, height: 70, justifyContent: 'flex-end' },
  bar: { width: 22, borderRadius: 4, minHeight: 2 },
